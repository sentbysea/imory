...
> **§22** 다.
>
> ★ **v2 는 이제 그려지고 고쳐진다.** `HOME-CANVAS-V2-DATA-1`(2026-09-21,
> 계약 **§9-(3)**) → `V2-FLOW-RENDER-1`(2026-09-22, **§23**) →
...
> 사진과 빈 이미지 슬롯을 함께 만든다) → `V2-ELEMENTS-1`(2026-09-22,
...
| 3e-1 | `HOME-CANVAS-V2-DATA-1` | v2 normalize · validate · resolve · 보존. **DOM renderer 없음** | 없음(데이터) | **완료**(2026-09-21) — 결과는 [계약 문서 §9-(3)](../contracts/IMORY_HOME_CANVAS_CONTRACT.md) |
...
> **✅ `V2-ELEMENTS-1`(2026-09-22)이 이 절의 **단독 선택 하나**짜리
> 묶기 · 빼기를 구현했다 — 지금 코드가 강제하는 것은
...
### 14-10. 편집 UX 계약 (구현은 `V2-EDITOR-1A`·`1B` · `V2-ADD-1` · `V2-ELEMENTS-1`)
